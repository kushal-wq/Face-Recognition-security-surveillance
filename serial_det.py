...
class CombinedRecognitionApp(QWidget):
    ...
    def create_data_collection_tab(self):
        ...
        self.training_label.setStyleSheet("border: 2px solid #dddddd; border-radius: 4px;")
    ...
    def create_face_recognition_tab(self):
        ...
        self.face_video_label.setStyleSheet("border: 2px solid #dddddd; border-radius: 4px;")
